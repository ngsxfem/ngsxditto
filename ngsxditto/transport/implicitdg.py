...
class ImplicitDGTransport(BaseTransport):
    ...
    def UpdateForms(self):
        ...
        if skeleton_form2:
            ...
            self.lf += -self.dt*(IfPos((self.wind*n), 0, (self.wind*n) * self.past * v * self.bnd_facets_ind)).Compile() * dx(definedonelements=self.active_elements, element_boundary=True, bonus_intorder=0)  # integral on boundary facets
